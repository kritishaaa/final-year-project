...
class ParcelTable extends DataTableComponent
{
    use SessionFlash;
    ...
    public function delete($id)
    {
        ...
        $service = new Parcel();
        $service->delete(Parcel::findOrFail($id));
        $this->successFlash("Parcel Deleted Successfully");
    }
